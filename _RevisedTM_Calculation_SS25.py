...
calc_date = '2025-03-17'
arc_date = '2025-03-05'

current_season = 'AW24'
current_eos_date = '2025-04-01'

new_season = 'SS25'
new_eos_date = '2025-05-01'
...
tm_reduction_cond = [((old_df['season'] == last_season) & (old_df['season_group'] == '3. Seasonal') & (old_df['actual_st'] < 0.3)),
                     ((old_df['season'] == last_season) & (old_df['season_group'] == '3. Seasonal') & (old_df['actual_st'] < 0.6)),
                     ((old_df['season'] == last_season) & (old_df['season_group'] == '3. Seasonal') & (old_df['actual_st'] < 0.95)),
                     ((old_df['season'] == last_season) & (old_df['season_group'] == '3. Seasonal') & (old_df['actual_st'] <= 1)),
                     ((old_df['season'] == last_season) & (old_df['season_group'] == '2. Seasonal no MD') & (old_df['actual_st'] < 0.25)),
                     ((old_df['season'] == last_season) & (old_df['season_group'] == '2. Seasonal no MD') & (old_df['actual_st'] < 0.4)),
                     ((old_df['season'] == last_season) & (old_df['season_group'] == '2. Seasonal no MD') & (old_df['actual_st'] < 0.85)),
                     ((old_df['season'] == last_season) & (old_df['season_group'] == '2. Seasonal no MD') & (old_df['actual_st'] <= 1)),
                     ((old_df['season'] != last_season) & (old_df['season_group'] == '3. Seasonal') & (old_df['actual_st'] < 0.3)),
                     ((old_df['season'] != last_season) & (old_df['season_group'] == '3. Seasonal') & (old_df['actual_st'] < 0.6)),
                     ((old_df['season'] != last_season) & (old_df['season_group'] == '3. Seasonal') & (old_df['actual_st'] < 0.95)),
                     ((old_df['season'] != last_season) & (old_df['season_group'] == '3. Seasonal') & (old_df['actual_st'] <= 1)),
                     ((old_df['season'] != last_season) & (old_df['season_group'] == '2. Seasonal no MD') & (old_df['actual_st'] < 0.25)),
...
reducted_tm_os = [-0.50, -0.40, -0.40, old_df['actual_gm_im'],
                  ...
                  -0.50, -0.40, -0.40, old_df['actual_gm_im'],
                  -0.50, -0.40, -0.30, old_df['actual_gm_im']]
max_reduction = [-0.2, -0.2, -0.2, 0,
                 -0.15, -0.15, -0.15, 0,
                 -0.2, -0.2, -0.2, 0,
                 -0.15, -0.15, -0.15, 0]
...
# print(old_df.loc[old_df['season_group'] == '4. Protected Categories'])
...
# old_summary = restricted_cat(old_summary)
...
# print(co_df.loc[co_df['season_group'] == '4. Protected Categories'])
...
# co_summary = restricted_cat(co_summary)
